    ...
    <div class="row">
        <div class="column">
            ...
            <ul style="text-align: left; margin-left: 80px;">
                {% for shelter in current_shelter_list %}
                    <a href="{{ shelter.id }}/update" >{{shelter.shelter_name}}</a><br>
                    Location: {{shelter.shelter_location}}
                    <br><br>
                {% endfor %}
            </ul>
        </div>
        <div class="column">
            ...
            <ul style="text-align: left; margin-left: 80px;">
                {% for shelter in current_shelter_list %}
                    <a href="{{ shelter.id }}/delete" >{{ shelter.shelter_name }}</a><br>
                    Location: {{ shelter.shelter_location }}
                    <br><br>
                {% endfor %}
            </ul>
